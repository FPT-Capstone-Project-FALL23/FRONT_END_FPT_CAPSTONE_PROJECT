import { URL_BLOCK_USER, URL_GET_ALL_CLIENTS, URL_GET_ALL_EVENT_ISACTIVE_FALSE, URL_GET_ALL_ODRERS, URL_GET_ALL_ORGANIZAER, URL_GET_ALL_ORGANIZAER_ISACTIVE_FALSE, URL_GET_DETAIL_CLIENT, URL_GET_DETAIL_EVENT, URL_GET_DETAIL_ORGANIZAER, URL_GET_IS_REFUND, URL_GET_TOTAL_AMOUNT_AND_ADMIN_EARNING, URL_LIST_BLOCK_ORGANIZER, URL_REFUND_MONEY, URL_SET_IS_ACTIVE_EVENT, URL_SET_IS_ACTIVE_ORGANIZAER } from "../ConstAPI";
...
const ApiAdmin = {
    ...
    getListOrganizerBlock(data) {
        return axiosDefault.get(URL_LIST_BLOCK_ORGANIZER, data)
    }
}
