...
const ApiAdmin = {
    ...
    rejectedOrganizer(data) {
        return axiosDefault.post(URL_REJECTED_ORGANIZAER, data)
    },
    rejectedEvent(data) {
        return axiosDefault.post(URL_REJECTED_EVENT, data)
    },
}
